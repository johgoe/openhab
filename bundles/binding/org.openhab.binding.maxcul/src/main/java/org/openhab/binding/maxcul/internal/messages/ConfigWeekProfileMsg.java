...
import org.openhab.binding.maxcul.internal.MaxCulWeekProfile;
import org.openhab.binding.maxcul.internal.MaxCulWeekProfileControlPoint;
...
public class ConfigWeekProfileMsg extends BaseMsg{
	...
	private static final Logger logger = LoggerFactory
			.getLogger(ConfigWeekProfileMsg.class);
	...
	public ConfigWeekProfileMsg(byte msgCount, byte msgFlag, byte groupId,
			String srcAddr, String dstAddr, MaxCulWeekProfilePart weekProfile, boolean secondHalf) {
		super(msgCount, msgFlag, MaxCulMsgType.CONFIG_WEEK_PROFILE, groupId,
				srcAddr, dstAddr);
	...
	private byte[] buildPayload() {
		  ...
		  for(int i = start; i < end; i++){
			...
			int value = ((int)(controlPoint.getTemperature()*2) << 9) | (int)((controlPoint.getHour() * 60 + controlPoint.getMin())/5f);
